        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-[2fr_1.3fr_1.3fr_1fr_1fr] gap-8 lg:gap-12">
          ...
          <div>
            ...
            <p className="text-gray-400 mb-6 leading-relaxed">
              Premier software and VoIP solutions provider, delivering innovative technology
              solutions to businesses worldwide. Transforming ideas into powerful digital experiences.
            </p>
            ...
            <div className="space-y-3">
              <div className="flex items-start space-x-3">
                ...
                <p className="text-sm text-gray-400">
                  123 gandhinagar , info city<br />
                  Gandhinagar, Gujarat 360001, India
                </p>
              </div>
              ...
              <div className="flex items-center space-x-3">
                ...
                <a href="mailto:info@driansh.com" className="text-sm text-gray-400 hover:text-blue-400 transition-colors">
                  info@driansh.com
                </a>
              </div>
            </div>
