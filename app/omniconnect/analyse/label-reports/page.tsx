...
const labelHighlights = [
  {
    ...
    imageSrc: "/images/analyse/lable-report/label-overview.png",
  ...
  },
  {
    ...
    imageSrc: "/images/analyse/lable-report/label-report-filters.png",
    ...
    <main className="min-h-screen bg-white pt-28 pb-20">
      ...
      <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <h1 className="text-3xl sm:text-4xl lg:text-5xl font-semibold text-gray-900 mb-4">
          Your conversations’ health report, filtered by labels
        </h1>
      ...
      <section className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 mt-16 space-y-20">
        {labelHighlights.map((highlight, index) => {
